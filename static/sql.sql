...
/*
UPDATE `user` SET `us_pic` = '4.jpg' WHERE `us_id` = '1'  修改某一行某一列
*/
...
CREATE TABLE `estimate` (
  ...
  `es_score` float(32) DEFAULT NULL,
...
insert  into `estimate`(`es_id`,`dh_id`,`us_id`,`es_content`,`es_date`,`es_score`,`es_star`,`es_main_img`,`hot`,`rihan`,`specialty`,`noodles`,`meat`,`daily`) values (1,1,2,'最喜欢这个菜了，强推强推','2018-12-01','5','56','1.jpg',0,0,0,0,0,0),(2,1,1,'太好吃啦！就是生意太好了，人太多，排队排了好久，但是是真的好吃','2018-09-16','4.5','45','2.jpg',0,0,1,1,0,0),(3,2,1,'第N次来这里吃东西了，超好吃，强力推荐，一定要吃这家店的招牌','2019-01-16','4.9','23','3.jpg',0,0,NULL,0,1,0),(4,2,3,'每周必点的一顿，下课后直接飞奔而来。太好吃了','2019-03-26','4.6','56','4.jpg',0,1,1,1,0,0),(5,3,3,'最近爱上了这道菜，连续吃了三天也不腻，也是真好吃了','2019-03-06','4.5','15','5.jpg',0,NULL,0,0,0,0),(6,3,4,'这个菜挺好吃的，还不贵，老板热人还超好的','2019-01-06','4.7','46','5.jpg',0,0,NULL,0,1,0),(7,4,2,'这个味儿佷鲜，还不是很腻，超喜欢吃的','2018-12-01','4.8','53','6.jpg',0,0,0,0,0,0),(8,4,4,'我从未尝过如此美味的食物，真是好吃啊','2018-09-16','4','49','7.jpg',0,0,0,1,0,0),(9,5,1,'真是好吃的这个，特别是不知道吃啥的时，直接走进这家店准没错','2019-01-16','5','67','8.jpg',0,0,0,NULL,0,0),(10,5,6,'从大一开始就超喜欢这个店的东西，好吃便宜，非常感人','2019-03-26','4.9','39','9.jpg',0,NULL,1,0,0,0),(11,6,8,'上次把手机拉在这里了，老板很好心的给我保留着让我来拿，感恩，老板家的东西也超好吃','2019-03-06','4.6','55','10.jpg',0,0,0,0,0,0),(12,6,3,'浙理最好吃的电，没有之一，单方面承认，不接受反驳','2019-01-06','4.7','66','11.jpg',0,0,0,0,0,0),(13,7,4,'啊啊啊啊啊，最喜欢这个菜了，强推强推','2019-03-26','4.4','49','12.jpg',0,0,NULL,1,1,0),(14,7,5,'没什么好说的了，就是好吃！！！','2018-12-01','4.3','68','13.jpg',0,1,1,0,0,0),(15,8,5,'还蛮好吃的这个菜，偶尔跟室友一起来这家店吃，不会失望','2018-09-16','4.6','85','14.jpg',0,NULL,0,0,0,0),(16,8,2,'真是好吃的呀，不容错过的浙理良心商家，店铺','2019-01-16','4.9','82','15.jpg',0,0,0,0,0,0),(17,8,6,'好吃到飞上天，真是爽到飞起。这味道杠杠的','2019-03-26','4.5','73','16.jpg',0,1,NULL,0,1,0),(18,9,6,'很好吃，超好的，超美味的，哈哈哈哈哈哈哈哈哈哈哈哈来吃来吃啊','2019-03-06','4.6','61','17.jpg',0,0,1,NULL,0,0),(19,9,7,'十分满意吃的超开心的呢！！！','2019-01-06','4.7','64','18.jpg',0,0,0,0,0,0),(20,10,7,'昨天吃的这个菜，蛮好吃的，可以常来啊','2018-12-01','4.3','29','19.jpg',0,0,0,0,0,0),(21,10,7,'惊喜，以为会很一般，但是真的很好吃啊！','2018-09-16','4.6','49','20.jpg',0,NULL,0,1,0,0),(22,2,3,'每周必点的一顿，下课后直接飞奔而来。太好吃了','2019-03-26','4.6','56','21.jpg',0,1,1,1,0,0),(23,4,4,'我从未尝过如此美味的食物，真是好吃啊','2018-09-16','4','49','22.jpg',0,0,0,1,0,0),(24,6,3,'浙理最好吃的电，没有之一，单方面承认，不接受反驳','2019-01-06','4.7','66','23.jpg',0,0,0,0,0,0),(25,8,6,'好吃到飞上天，真是爽到飞起。这味道杠杠的','2019-03-26','4.5','73','24.jpg',0,1,NULL,0,1,0);
...
insert  into `user`(`us_id`,`dh_id`,`us_ph`,`us_name`,`us_pwd`,`us_pic`,`us_sign`,`us_birh`,`us_email`) values (1,1,'18177310581','Admin','Admin','1.jpg','我就是我，不一样的烟火',2001-06-04,'153769507@qq.com'),(2,0,'18177310581','admin','123456','2.jpg','我就是我，不一样的烟火','1999-03-15','153769507@qq.com'),(3,0,'15858197901','张三','123456','3.jpg','小小吃货一枚','2000-04-19','153769507@qq.com'),(4,0,'15858197906','李四','123456','43.jpg','尼古拉斯·赵四就是我，是的！','2000-10-01','153769507@qq.com');
